...
public class ExploreFragments extends Fragment {
    ...
    AdapterStudent mAdapter;// an adapter that combines the firebase reference to the recycler view in our UI
...
//                        toast.show();
                ...
                mAdapter = new AdapterStudent(list, recyclerViewMenu.getContext(), list_of_id);
